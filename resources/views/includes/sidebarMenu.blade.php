                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{route('questions.index')}}">Create Question</a>
                            <a class="nav-link" href="">Manage Question</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{route('ans.index')}}">Create Ans</a>
                            <a class="nav-link" href="">Manage Ans</a>
                        </nav>
                    </div>
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts14" aria-expanded="false" aria-controls="collapseLayouts14">
                        <div class="sb-nav-link-icon"><i class="fa-solid fa-code"></i></div>
                     Code
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse" id="collapseLayouts14" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{route('code.index')}}">Code Create</a>
                            <a class="nav-link" href="">Code Manage</a>
                        </nav>
                    </div>
