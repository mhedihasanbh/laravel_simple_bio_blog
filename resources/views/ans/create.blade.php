...
<div class="container"> 
    <div class="row"> 
        <div class="col-md-12 mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Questioin Ans</h4>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label"><b>Text</b></label>
                            <div class="col-sm-10">
                                <textarea class="form-control " id="ckeditor" name="text" rows="30" cols="50" id="horizontal-email-input17"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label"><b>Author Name</b></label>
                            <div class="col-sm-10">
                                <input type="text" name="autho_name" class="form-control" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label"><b>Author Url</b></label>
                            <div class="col-sm-10">
                                <input type="text" name="author_url" class="form-control" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label"><b>Source</b></label>
                            <div class="col-sm-10">
